...
type SnowflakeServiceClient interface {
	...
	Next2(ctx context.Context, in *Snowflake_Param, opts ...grpc.CallOption) (*Snowflake_UUID, error)
}
...
func (c *snowflakeServiceClient) Next2(ctx context.Context, in *Snowflake_Param, opts ...grpc.CallOption) (*Snowflake_UUID, error) {
	out := new(Snowflake_UUID)
...
type SnowflakeServiceServer interface {
	...
	Next2(context.Context, *Snowflake_Param) (*Snowflake_UUID, error)
}
...
var fileDescriptor0 = []byte{
	...
	0x30, 0x72, 0x09, 0xc0, 0xdd, 0x18, 0x9c, 0x5a, 0x54, 0x96, 0x99, 0x9c, 0x2a, 0x64, 0xc2, 0xc5,
	...
	0x28, 0x41, 0xf6, 0x80, 0x28, 0x86, 0x2c, 0x58, 0x93, 0x19, 0x17, 0x2b, 0xc8, 0x56, 0x23, 0x21,
	0x4c, 0x0b, 0xc0, 0x7e, 0xc2, 0xa1, 0x2f, 0x89, 0x0d, 0x2c, 0x6a, 0x0c, 0x08, 0x00, 0x00, 0xff,
	0xff, 0xf7, 0x6d, 0xe2, 0x82, 0x87, 0x01, 0x00, 0x00,
}
